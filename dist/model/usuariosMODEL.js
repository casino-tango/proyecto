...
export const usuarios = sequelize.define('usuario', {
  ...
  ubicacion_del_elemento: {
    type: DataTypes.ENUM('Popayán Centro Comercial Campanario Casino Tango', 'Popayán Centro Comercial Terraplaza Casino Tango', 'Pasto Parque Infantil Casino Tango', 'Admin', 'Ipiales Casino Tango')
  }
}, {
  timestamps: false
});
